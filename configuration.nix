...

{
  ...
  # Enable the LightDM display manager and autologin
  ...
  # Enable steam and steam hardware
  programs.steam.enable = true;
  hardware.steam-hardware.enable = true;

  # Enable Xbox Wireless Adapter driver
  ...
  # Enable samba searching in file managers
